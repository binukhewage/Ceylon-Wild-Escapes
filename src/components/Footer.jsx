        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <p className="font-lora text-gray-400 text-sm leading-7 max-w-sm">
              We curate immersive expeditions into Sri Lanka's untouched
              wilderness. Where luxury meets the raw, untamed soul of nature.
            </p>
          ...
          <div className="lg:col-span-2 lg:pl-8">
            ...
            <ul className="space-y-4">
              {["Home", "Gallery", "About", "Tours"].map((item) => (
                <li key={item}>
                  <Link
                    href={`/${item.toLowerCase().replace(" ", "-")}`}
                    className="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-300 font-lora text-sm"
                  >
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item}>
                  <Link
                    href="/tours"
                    className="group flex items-center justify-between text-gray-400 hover:text-white transition-colors duration-300 font-lora text-sm border-b border-white/5 pb-2 hover:border-[#4a7c59]/50"
                  >
                    {item}
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6 font-lora text-sm text-gray-400">
              <p className="leading-relaxed">
                <span className="block text-white mb-1 font-montserrat text-xs uppercase tracking-wide">
                  Headquarters
                </span>
                No 21/12A, Dewala Road,
                <br />
                Pagoda, Nugegoda, <br /> Sri Lanka.
              </p>
              ...
              <div>
                ...
                <a
                  href="mailto:info@ceylonwildescapes.com"
                  className="hover:text-[#4a7c59] transition-colors"
                >
                  info@ceylonwildescapes.com
                </a>
              </div>
